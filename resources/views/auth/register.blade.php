...
<hr>
 ...
 <form role="form" method="POST" action="{{ route('register') }}" class="form-horizontal">
	...
	<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6">
			<input name="name" id="datebook-profile-name" value="{{ old('name') }}" class="form-control" type="text">
		</div>
		@if ($errors->has('name'))
	...
	<div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6 datebook-profile-country">
			...
			<div class="input-group">
				...
				<input id="datebook-locationcountry" name="country" value="sa" type="hidden">
				<input id="datebook-locationregion" name="state" value="sa" type="hidden">
				<input id="datebook-locationcity" name="city" value="sa" type="hidden">
...
<div class="datebook-countries-overlay">
		...
		<div class="col-sm-6">
			...
			<div id="datebook-birth" class="row datebook-padding-less">
				<div class="col-xs-3 datebook-padding-less ">
					...
					<div class="btn-group bootstrap-select form-control datebook-dateday {{ $errors->has('day') ? ' has-error' : '' }}">
					<select name="day" id="datebook-dateday" class="selectpicker form-control datebook-dateday" tabindex="-98">
				...
				<div class="col-xs-5 datebook-padding-less ">
					...
					<div class="btn-group bootstrap-select form-control datebook-datemonth {{ $errors->has('month') ? ' has-error' : '' }}"><select name="month" id="datebook-datemonth" class="selectpicker form-control datebook-datemonth" tabindex="-98">
				...
				<div class="col-xs-4 datebook-padding-less ">
					...
					<div class="btn-group bootstrap-select form-control datebook-dateyear {{ $errors->has('year') ? ' has-error' : '' }}"><select name="year" id="datebook-dateyear" class="selectpicker form-control datebook-dateyear" tabindex="-98">
	...
	<div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6 datebook-register-panel">
			...
			<div class="btn-group btn-group-justified" data-toggle="buttons">
						...
						<img src="{{ url('/') }}/images/icon_female_search.png" alt=""> 
						...
						<img src="{{ url('/') }}/images/icon_male_search.png" alt=""> 
	...
	<div class="form-group {{ $errors->has('sexualorientation') ? ' has-error' : '' }}">
	...
	<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6">
			<input name="email" id="datebookemailaddress" value="{{ old('email') }}" class="form-control" type="email">
	...
	<div class="form-group {{ $errors->has('username') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6">
			<input name="username" id="datebookuser" value="{{ old('username') }}" autocomplete="off" class="form-control" title="Username is set only once during registration and cannot be changed" type="text">
	...
	<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
		...
		<div class="col-sm-6">
			<input name="password" id="datebook-newpass" value="" class="form-control" autocomplete="off" type="password">
						<div class="clear"></div>
...
<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
	<div class="datebook-terms-padding">
		...
		By submitting data you agree to our <a href="{{ url('/') }}/terms/" target="_blank">Terms and Conditions</a>		
	</div>
</div>
...
<img class="img-responsive" src="{{ url('/') }}/images/welcome-people.jpg" alt="">
