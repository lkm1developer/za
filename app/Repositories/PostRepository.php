...
public function getPostById($slug)
	...
	{
		$ret['resent_post']=Post::where('active', 1)
               ->orderBy('id', 'desc')
               ->take(5)
               ->get();
		
	   $ret['resent_comment']=Comment::orderBy('id', 'desc')->take(5)->get();
       $ret['tags']=Tag::orderBy('id', 'desc')->take(5)->get();
       $ret['cat']=Category::orderBy('id', 'desc')->take(5)->get();
        return $ret;      
