...
<div class="container" style="background: url(
	...
	<?php echo e(url('/')); ?>/images/welcome-bg.png
			...
			<div class="navbar-user-panel datebook-header-user-panel">
				<div class="navbar navbar-default datebook-no-border tooltip-demo">
					...
					<ul class="nav navbar-nav datebook-register-links">
						...
						<li><a href="<?php echo e(url('/')); ?>/profilesearch/" title=""><span class="badge badge-info">299</span> registered members</a></li>
					...
					<ul class="nav navbar-nav navbar-right datebook-register-links">
						...
						<li><a href="<?php echo e(url('/')); ?>/registration/"><i class="fa fa-check-circle fa-lg text-yellow"></i> Register</a></li>
...
<div class="panel panel-default datebook-no-border  datebook-front-search">
	...
	<div class="panel-body">
		...
		<form action="<?php echo e(url('/')); ?>/profilesearch/" method="post" class="form-inline">
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="btn-group btn-group-justified datebook-gender-input" data-toggle="buttons">
							...
							<label class="btn btn-default datebook-search-btn active" title="Woman"><img src="<?php echo e(url('/')); ?>/images/icon_female_search.png" alt=""> <input name="gender" class="datebook-gender" value="1" checked="" type="radio"> Woman</label><label class="btn btn-default datebook-search-btn" title="Man"><img src="<?php echo e(url('/')); ?>/images/icon_male_search.png" alt=""> <input name="gender" class="datebook-gender" value="2" type="radio"> Man</label>
						</div>
					</div>
				</div>
			</div>
