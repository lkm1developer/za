    ...
    <div id="container_full">
        <div class="container">
            <div class="ecommerce">
				...
				<form name="checkout" method="post" class="checkout ecommerce-checkout" action="<?php echo e(URL::to('/')); ?>/plan/makeorder" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>

					<input type="hidden" name="planid"value="<?php echo e($planid); ?>"/>	
