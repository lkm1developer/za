							...
							<div class="top-social col-sm-4">
								<div class="social-top">
									...
									<!--li class="bounceIn animated"><a target="_blank" href="http://facebook.com"><i class="fa fa-facebook"></i></a></li>
										  ...
										  <li class="bounceIn animated"><a target="_blank" href="#"><span>Language</span></a></li>
										  <li class="bounceIn animated"><div id="google_translate_element"></div></li>
							...
							<div class="top-info col-sm-8 pull-right">
								...
								<ul>
									...
									<li><a href="#"><i class="fa fa-envelope"></i>Email Us</a></li>
												<li class="userarea"><a href="#"><i class="fa fa-user"></i>Client area</a></li>
								</ul>                   
							</div>
						</div>
					</div>
