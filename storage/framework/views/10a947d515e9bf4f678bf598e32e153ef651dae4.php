...
<?php $__env->stopSection(); ?>
    ...
    <a href="<?php echo e(route('pages.create')); ?>" class="btn btn-primary"><?php echo app('translator')->getFromJson('New Page'); ?></a>
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            ...
                            <?php endif; ?>
                            <?php echo $__env->make('back.page.table', compact('pages'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </tbody>
                    </table>
                </div>
                <!-- /.box-body -->
