            ...
            <li class="dropdown notifications-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fa fa-bell-o"></i>
                  ...
                  <span class="label label-warning"><?php echo e($countNotifications); ?></span>

              </a>
              <ul class="dropdown-menu">
                <li class="header"><?php echo app('translator')->getFromJson('New notifications'); ?></li>
                <li>
                  <!-- Inner Menu: contains the notifications -->
                  <ul class="menu">
                    <li><!-- start notification -->
                      <a href="#">
                        <i class="fa fa-users text-aqua"></i> <?php echo e($countNotifications); ?> <?php echo app('translator')->getFromJson('new'); ?> <?php echo e(trans_choice(__('comment|comments'), $countNotifications)); ?>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php if($countNotifications): ?>
          <li><a href="<?php echo e(route('notifications.index', [auth()->id()])); ?>"><i class="fa fa-bell"></i> <span><?php echo app('translator')->getFromJson('Notifications'); ?></span></a></li>
        <?php endif; ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li <?php if($loop->last && $item['url'] === '#'): ?> class="active" <?php endif; ?>>
            <?php if($item['url'] !== '#'): ?>
              <a href="<?php echo e($item['url']); ?>">
            <?php endif; ?>
            <?php if(isset($item['icon'])): ?>
              <span class="fa fa-<?php echo e($item['icon']); ?>"></span>
            <?php endif; ?>
